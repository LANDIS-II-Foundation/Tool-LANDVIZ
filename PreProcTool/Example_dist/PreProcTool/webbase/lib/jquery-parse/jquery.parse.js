...
(function($)
{
	...
	function Parser(config)
	{
		...
		function validConfig(config)
		{
			...
			if (typeof config.trimWhite !== 'boolean')
				config.trimWhite = _defaultConfig.trimWhite;
